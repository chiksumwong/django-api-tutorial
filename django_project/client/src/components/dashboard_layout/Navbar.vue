<template>
  <header>
    <b-navbar toggleable="md" class="pl-0">
      ...
      <!-- Left Side -->
      <div class="row ml-auto w-100 mr-2">
        <!-- Size and Language -->
        <div class="col-sm-12 d-none d-md-block d-lg-block d-xl-block">
          <div class="row justify-content-end">
            ...
            <div id="language" class="row">
              <div id="lang-en" v-show="l_en" @click="lang('en')">English</div>
              <div v-show="l_s1">|</div>
              <div id="lang-tw" v-show="l_tw" @click="lang('tw')">繁體</div>
              <div v-show="l_s2">|</div>
              <div id="lang-cn" v-show="l_cn" @click="lang('cn')">简体</div>
            </div>
          </div>
        </div>
        <!-- System Name -->
        <div class="col-sm-12 d-none d-md-block d-lg-block d-xl-block">
          <div class="row justify-content-end">
            <h1 class="name">Django API Tutorial - Dashboard</h1>
          </div>
        </div>
      </div>
    </b-navbar>
